# -*- coding: utf-8 -*-
"""
Created on Sun Apr 28 10:41:43 2024
...
st.set_page_config(page_title='My superstore', page_icon=':bar_chart:', layout='wide')
...
with col1:
    date1 = pd.to_datetime(st.date_input("Strat date",start_date))
